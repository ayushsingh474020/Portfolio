      ...
      <div className="container mx-auto">
        <div className="max-w-[400px] mx-auto xl:mx-0 text-center xl:text-left mb-12 xl:h-[400px] flex flex-col justify-center items-center xl:items-start">
          ...
          <p className="subtitle mb-8">
            Here are some of the projects I’ve recently worked on, showcasing my
            experience in{" "}
            <strong>
              full-stack development, backend engineering, AI-powered
              applications, and modern web technologies
            </strong>
            . From building{" "}
            <strong>
              AI-driven email automation and task management systems
            </strong>{" "}
            to real-time chat applications and video-watching platforms, each
            project reflects my focus on building{" "}
